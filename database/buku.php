...
"penulis_buku" => "Pidi Baiq",
"penerbit_buku" => "Pastel Books",
"tahun_terbit" => "2015",
"halaman" => "344",
...
"stok_buku" => "21",
"gambar" => "163966692028409.jpeg",
];
$buku[] = [
"id" => "1639666943445",
"isbn" => "9797591514",
"judul_buku" => "5 CM",
"penulis_buku" => "Donny Dhirgantoro",
"penerbit_buku" => "PT Grasindo",
"tahun_terbit" => "2007",
"halaman" => "381",
"deskripsi" => "Novel menceritakan perjalanan 5 sahabat bernama Zafran, Ian, Arial, Genta dan Riani. Mereka adalah anak yang baik, pecinta musik, film, chatting, suka ngobrol, menyela dan khilaf.

Persahabat kelima anak muda tersebut sangat kuat. Ditambah lagi dengan adanya kisah percintaan yang turut mewarnai cerita.",
"stok_buku" => "32",
"gambar" => "163966694384586.jpg",
];
$buku[] = [
"id" => "1639666966540",
"isbn" => "6027870419",
...
"penulis_buku" => "Pidi Baiq",
"penerbit_buku" => "Pastel Books (Mizan Group)",
"tahun_terbit" => "2014",
"halaman" => "332",
"deskripsi" => "Milea, kamu cantik, tapi aku belum mencintaimu. Enggak tahu kalau sore. Tunggu aja. Milea, jangan pernah bilang ke aku ada yang menyakitimu, nanti, besoknya, orang itu akan hilang. Cinta sejati adalah kenyamanan, kepercayaan, dan dukungan. Kalau kamu tidak setuju, aku tidak peduli.",
"stok_buku" => "100",
"gambar" => "163966696638718.jpg",
];
$buku[] = [
"id" => "1639666987156",
"isbn" => "9789792248616",
...
"tahun_terbit" => "2009",
"halaman" => "432",
"deskripsi" => "Alif lahir di pinggir Danau Maninjau dan tidak pernah menginjak tanah di luar ranah Minangkabau. Masa kecilnya adalah berburu durian runtuh di rimba Bukit Barisan, bermain bola di sawah berlumpur dan tentu mandi berkecipak di air biru Danau Maninjau.
...
"penulis_buku" => "Raditya Dika",
"penerbit_buku" => "-",
"tahun_terbit" => "2015",
"halaman" => "260",
"deskripsi" => "Memasuki tahun kesepuluh sebagai penulis, Raditya Dika melahirkan karya terbarunya Koala Kumal. Masih mengusung genre yang sama kisah-kisah komedi yang didasarkan pada pengalaman si penulis, kali ini lewat Koala Kumal, Raditya Dika mengajak pembacanya berbicara tentang hubungan yang patah. Mulai dari renggangnya hubungan pertemanan, perasaan yang berubah kepada orang yang sama, hubungan orangtua dan anak, hingga patah hati terhebat yang mengubah cara pandang terhadap cinta.",
"stok_buku" => "10",
"gambar" => "163970511887182.jpg",
];
$buku[] = [
"id" => "1639706132490",
"isbn" => "9789791227780",
